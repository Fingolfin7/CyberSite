...
urlpatterns = [
    ...
    path('analysis/<int:case_pk>/issue/<int:pk>/delete', views.IssueDeleteView.as_view(), name='issue-delete'),
    path('import_report/<int:pk>', views.importReport, name='import_report'),
